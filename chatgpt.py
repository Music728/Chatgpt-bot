...
MAIN = [
    ...
    [
        InlineKeyboardButton(text="OWNER", url=f"https://t.me/DEVELOPER_OWNER"),
        InlineKeyboardButton(text=" ᴜᴘᴅᴀᴛᴇs ", url=f"https://t.me/OPEN_AI_BOTSS"),
    ],
]
X = [
    [
...
HELP_BACK = [
     [
           InlineKeyboardButton(text="Qᴜᴇꜱᴛɪᴏɴ ᴛʜᴀᴛ ᴄʜᴀᴛɢᴘᴛ ᴄᴀɴ ꜱᴏʟᴠᴇ ", url=f"https://t.me/DEVELOPER_OWNER"),
...
if __name__ == "__main__":
    ...
    print(f"""CONTACT  @DEVELOPER_OWNER
